...
To understand what Kubernetes does, you should know what a _Container_ is. If you're not familiar with it, I recommend you to read my [docker post][https://kogit.co/knowledges/whats-docker/] first, then come back to this thread.
